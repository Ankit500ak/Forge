...
export const generateMLTasksBatch = async (req, res) => {
  ...
  try {
    ...
    console.log(`[ML] ✅ Generated ${generatedTasks.length} tasks`);
  ...
  try {
    ...
    try {
      ...
      if (updates.length > 1) {
        ...
        console.log(`[Tasks] ✅ Stat rewards applied to user: ${JSON.stringify(appliedStats)} (rows affected: ${updateResult.rowCount})`);
      }
    } catch (statErr) {
